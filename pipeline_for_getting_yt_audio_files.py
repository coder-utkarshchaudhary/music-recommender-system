...
#    I am not using drive anymore. All files are being locally stored.
...
#     except:
#         print("Skipped a file here.")

# DRIVE_FOLDER_ID = "1KnqSDr72WKcQjj00IwTa_UFCHXIqFukw"

def main(data, output_path, start_idx, len=1000):
...
if __name__ == "__main__":
    ...
    main(data=raw_data, output_path=r'song_file', start_idx=20000)